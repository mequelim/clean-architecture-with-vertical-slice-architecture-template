...
```powershell
# At `CleanArchitectureWithVerticalSliceArchitectureTemplate\`
dotnet ef migrations add {MigrationName} --project .\CleanArchWithVerticalSliceArchTemplate.Infrastructure\ --startup-project .\CleanArchWithVerticalSliceArchTemplate.WebApi\ --output-dir Persistence\Migrations
```
...
```powershell
dotnet ef database update --project .\CleanArchWithVerticalSliceArchTemplate.Infrastructure\ --startup-project .\CleanArchWithVerticalSliceArchTemplate.WebApi\
```
