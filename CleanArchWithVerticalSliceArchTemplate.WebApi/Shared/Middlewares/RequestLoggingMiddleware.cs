...
{
    /// <summary>
    /// Middleware that logs details of incoming HTTP requests and their corresponding responses, including the HTTP method, request path, response status code, and processing duration.
    /// </summary>
    /// <remarks>
